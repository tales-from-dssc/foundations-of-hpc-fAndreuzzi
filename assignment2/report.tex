...
\begin{gather*}
    T(P,N) = \begin{cases}
        ...
        (1+\alpha(P)) \beta \frac{N}{\hat{P}} \log \frac{N}{\hat{P}} + \gamma_1 N \left(2 - \frac{1}{\hat{P}}\right) &\text{(OpenMP)}
    \end{cases}
\end{gather*}

This model testifies that in our experimental results, as we increase the number
...
\begin{figure}[t!]
    ...
    \caption{Performance after the compilation with compiler optimization flags.}
