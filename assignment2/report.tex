...
intensive operatiosn in our algorithm are the calls to
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Results obtained applying the method presented in Section \ref{sec:false_sharing} ($N = $ 100'000'000, $k = $ 3).}
